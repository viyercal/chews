...
// Always a real distance (owner's rule — no "right here"): feet to the
// nearest 50 under ~0.2 mi so a nearest-first list in a dense neighborhood
// stays distinguishable, tenths of a mile beyond that.
